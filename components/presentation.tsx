...
import { SlideInfographic } from "@/components/infographics"
...
const sectionAccent: Record<SlideData["section"], { bg: string; text: string; bar: string; badge: string }> = {
  ...
  transition: {
    bg: "bg-eu-light-blue",
    text: "text-eu-light-blue",
    bar: "bg-eu-light-blue",
    badge: "bg-eu-light-blue/10 text-eu-light-blue border-eu-light-blue/20",
  },
  pontusx: {
    bg: "bg-accent",
...
function SlideView({ slide }: { slide: SlideData }) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Two-column layout: Content + Infographic */}
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden sm:block">
              <div className="text-xs font-bold text-foreground leading-none">DELTADAO GAIAX</div>
